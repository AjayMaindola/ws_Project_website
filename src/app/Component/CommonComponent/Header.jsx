    ...
    <>
      <header className="bg-[url('/images/header/backgraound.jpg')] bg-no-repeat relative h-screen  ">
        <div className="bg-black w-full z-[1] h-full opacity-50 absolute"></div>
          <div className={`w-screen ${headerScrol ? "bg-white sticky top-0 z-[10]" : "relative z-[10] text-white" }`}>
              <div className=' max-w-[1340px] mx-auto pl-3 md:pl-[35px] lg:px-[10px] py-3 md:py-5 grid grid-cols-[60%_40%] md:gap-3 lg:gap-0 md:grid md:grid-cols-[15%_60%_20%] lg:grid lg:grid-cols-[15%_60%_auto] items-center'>
                ...
                <div className='flex justify-evenly md:justify-evenly items-center gap-3 '>
                   <div ><span className='  font-semibold text-[18px] hidden md:block hover:underline underline-offset-8 cursor-pointer'>Log in</span> <span><CiLogin className='  md:hidden' /></span> </div>
                   <div ><span className='  font-semibold text-[18px] hidden md:block hover:underline underline-offset-8 cursor-pointer'>Register</span> <span><FaUserPlus className='  md:hidden' /></span> </div>
                     <CgMenuGridR className='md:hidden' />
                </div>
            </div>
          </div>
          {/* Header Content work */}
